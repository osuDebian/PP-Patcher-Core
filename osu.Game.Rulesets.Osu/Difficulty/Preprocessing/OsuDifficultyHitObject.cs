...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing
{
    public class OsuDifficultyHitObject : DifficultyHitObject
    {
        ...
        private void setDistances()
        {
            ...
            ScalingFactor = (float)(Math.Pow(normalized_radius, 2.25) / Math.Pow((float)BaseObject.Radius, 2.25));
            ...
            {
                float smallCircleBonus = Math.Max(40 - (float)BaseObject.Radius, 0) / 180;
