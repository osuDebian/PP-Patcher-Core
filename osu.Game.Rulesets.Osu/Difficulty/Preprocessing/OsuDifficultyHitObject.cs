...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing
{
    public class OsuDifficultyHitObject : DifficultyHitObject
    {
        ...
        private void setDistances()
        {
            ...
            ScalingFactor = (float)(Math.Pow(normalized_radius, 1.05) / Math.Pow((float)BaseObject.Radius, 1.05));
            ...
            {
                float smallCircleBonus = Math.Max(35 - (float)BaseObject.Radius, 0) / 30;
