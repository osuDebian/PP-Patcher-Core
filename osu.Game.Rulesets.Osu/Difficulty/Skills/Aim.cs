...
namespace osu.Game.Rulesets.Osu.Difficulty.Skills
{
    ...
    public class Aim : OsuStrainSkill
    {
        ...
        protected override double StrainValueOf(DifficultyHitObject current)
        {
            ...
            //double angleBonus = 1 + database.strainsNoteAngle[index] * 0.1;
            ...
            return (calculateForJump(result, jumpDistanceExp * ScaleBonusDeltaTime, travelDistanceExp * ScaleBonusDeltaTime, osuCurrent.StrainTime) * 0.7 +
